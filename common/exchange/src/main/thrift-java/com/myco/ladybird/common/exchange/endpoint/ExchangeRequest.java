...
public class ExchangeRequest implements org.apache.thrift.TBase<ExchangeRequest, ExchangeRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ExchangeRequest> {
  ...
  public ExchangeRequestPayload payload; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PAYLOAD, new org.apache.thrift.meta_data.FieldMetaData("payload", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ExchangeRequestPayload.class)));
  ...
  public ExchangeRequest(
    ExchangeRequestPayload payload)
  {
    this();
  ...
  public ExchangeRequest(ExchangeRequest other) {
    if (other.isSetPayload()) {
      this.payload = new ExchangeRequestPayload(other.payload);
    }
  }
  ...
  public ExchangeRequestPayload getPayload() {
    return this.payload;
  }

  public ExchangeRequest setPayload(ExchangeRequestPayload payload) {
    this.payload = payload;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PAYLOAD:
      if (value == null) {
        ...
        setPayload((ExchangeRequestPayload)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // PAYLOAD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.payload = new ExchangeRequestPayload();
